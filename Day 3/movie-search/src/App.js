...
// https://omdbapi.com/?t=the avengers&apikey=995c09b7 

function App() {
  // state variable -- movie
  let [movieinfo, setMovieinfo] = useState(null);
  let [title, setTitle] = useState("iron man 2");
  ...
  function getMovieData() {
    let url = `https://omdbapi.com/?t=${title}&apikey=995c09b7`;
    fetch(url)
